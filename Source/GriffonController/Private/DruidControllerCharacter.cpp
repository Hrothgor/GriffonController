...
void ADruidControllerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ADruidControllerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADruidControllerCharacter::Move);
...
void ADruidControllerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADruidControllerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D

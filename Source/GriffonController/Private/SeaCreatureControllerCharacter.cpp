...
#include "SeaCreatureControllerCharacter.h"
...
// Sets default values
ASeaCreatureControllerCharacter::ASeaCreatureControllerCharacter()
{
...
void ASeaCreatureControllerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ASeaCreatureControllerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASeaCreatureControllerCharacter::Move);
...
void ASeaCreatureControllerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
// Called every frame
void ASeaCreatureControllerCharacter::Tick(float DeltaTime)
{
